...
describe("SushiSwapV2_Test",function(){   
    ...
    it("unlock caaount",async()=>{
        ...
        console.log("balance wbnb:",bal_wbnb); 
         ...
         await wbnb.connect(whale).approve(sushiSwap.address,_amountInArr);
        console.log("------------erc20 approve--------------------")

        await  sushiSwap.connect(whale).filterSwap(_pathArr);
        ...
        console.log("balanceOf_usdc1:",bal_usdc1);
      })
